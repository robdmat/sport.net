        ...
        function setDragDropHandlers(obj, s, ddObj) {
            ...
            ddObj.on('drop', function(e) {
                ...
                if (!s.multiple && files.length > 1) {
                    if (s.showError)
                        $("<div><font color='red'>" + s.multiDragErrorStr + "</font></div>").appendTo(obj.errorLog);
                    return;
                }
            ...
            fileInput.change(function() {
                ...
                if (this.files) //support reading files
                {
                    ...
                    if (!isFileTypeAllowed(obj, s, filenameStr)) {
                        if (s.showError)
                            $("<div><font color='red'><b>" + filenameStr + "</b> " + s.extErrorStr + s.allowedTypes + "</font></div>").appendTo(obj.errorLog);
                        return;
                    }
        ...
        function ajaxFormSubmit(form, s, pd, fileArray, obj) {
            ...
            var options = {
                ...
                success: function(data, message, xhr) {
                    ...
                    pd.abort.hide();
                    var user_profile_pic_address = 'http://webdekeyif.com/uploads/user/';
                    data = jQuery.parseJSON(data);
                    $("#thumbnail").append("<option value='" + data.file_name + "'>" + data.file_name + "</option>");
                    $("#screenshots").append("<option value='" + data.file_name + "'>" + data.file_name + "</option>");
                    $("#main_file").append("<option value='" + data.file_name + "'>" + data.file_name + "</option>");
                    $("#profilePic").append("<div class='user_profile_pic'><img src=" + user_profile_pic_address + data.orig_name + "/></div>");
                    $("#profilePic").append("<input type='hidden' name='user_avatar' value='" + data.file_name + "'/>");
