        ...
        function ajaxFormSubmit(form, s, pd, fileArray, obj) {
            ...
            var options = {
                ...
                success: function(data, message, xhr) {
                    ...
                    pd.abort.hide();
                    var user_profile_pic_address = 'http://testingsports.thinkigaming.com/uploads/feed/';
                    data = jQuery.parseJSON(data);
                    $("#feedFavicon").html(' ');
                    $("#feedFavicon").append("<div class='feed_favicon'><img src=" + user_profile_pic_address + data.orig_name + "></div>");
                    $("#feedFavicon").append("<input id='feed_favicon_icon' type='hidden' name='feed_favicon_icon' value='" + data.file_name + "'/>");
