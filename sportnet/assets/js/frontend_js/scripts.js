...
function addMenuItem() {
    $(':checkbox:checked').each(function (i) {
        ...
        $('#nestable > .dd-list').append('<li id="page-' + number + '" class="dd-item" data-exist_id="0" page-id="' + $(this).val() + '" data-label="' + $(this).attr('page-title') + '" data-link="' + $(this).attr('page-link') + '"><div class="dd-handle">' + $(this).attr('page-title') + '</div><a class="close" onclick="javacript:closeMenu(\'page-' + number + '\');">Ã—</a></li>');
    });
    $('#nestable').nestable();
}
...
function addCustomLink() {
    ...
    var number = 1 + Math.floor(Math.random() * 1000);
    $('#nestable > .dd-list').append('<li id="page-' + number + '" class="dd-item"  data-exist_id="0" data-label="' + title + '" data-link="' + url + '"><div class="dd-handle">' + title + '</div><a class="close" onclick="javacript:closeMenu(\'page-' + number + '\');">Ã—</a></li>');
    $('#nestable').nestable();
    $('#link-url').val('');
    $('#link-title').val('');
}
...
function newCollection() {
    $("#new_collection_button").trigger('click');
}

$('#new_collection').modal({keyboard: false});