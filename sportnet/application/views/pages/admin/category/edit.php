            ...
            <div class="row-fluid section">
                ...
                <div class="block">
                    ...
                    <div class="block-content collapse in">
                        <div class="row-fluid">
                            <?php echo form_open('category/edit/' . $category->id, array('class' => 'form-horizontal', 'enctype' => "multipart/form-data")); ?>
                            ...
                            <div class="control-group">
                                ...
                                <!-- control group---></div>
                            <div class="control-group">
                                <label class="control-label" for="category_name">Update Avatar</label>
                                <div class="controls">
                                    <?php
