...
<div id="shareMeDIv">
    ...
    <script>
//                jQuery('#feed_content li .wd100_wd main_content_share_button .slideToggleDivs').live("click", function () {
//            jQuery('#slot_list').addClass('ul_active');
//            jQuery(this).parent().slideToggle();

//        });
        function getShareDiv(id) {
//            jQuery(".main_content_share").css('display','none');
