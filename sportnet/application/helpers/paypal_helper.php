 ...
 * ****************************************** */
global $PROXY_HOST, $PROXY_PORT, $API_UserName, $API_Password, $API_Signature, $sBNCode, $API_Endpoint, $PAYPAL_URL, $PAYPAL_DG_URL, $USE_PROXY, $version;
...
//'------------------------------------
$API_UserName = 'erajaykumar321-facilitator_api1.gmail.com'; //this is hidden;
$API_Password = '1371747711'; //this is hidden;
$API_Signature = 'AaxdFe30VHtgWJLNmz4xLC9wHV9JA3SLVy01reHT46a-v..48.jLmAHt'; //this is hidden;
...
/*
  ...
  '
  ' For the sandbox, the URL is https://www.sandbox....checkout&token=
  ' For the live site, the URL is https://www.paypal.c...checkout&token=
 */
...
if (!function_exists('SetExpressCheckoutDG')) {
    ...
    function SetExpressCheckoutDG($paymentAmount, $currencyCodeType, $paymentType, $returnURL, $cancelURL, $items) {
        ...
        foreach ($items as $index => $item) {
            ...
            $nvpstr .= "&PAYMENTREQUEST_0_CUSTOM=" . urlencode($item["custom"]);
...
/* '----------------------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------------------
 */
if (!function_exists('RedirectToPayPal')) {
...
if (!function_exists('RedirectToPayPalDG')) {
...
if (!function_exists('deformatNVP')) {
